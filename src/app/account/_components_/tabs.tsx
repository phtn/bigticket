  ...
  return (
    <div className="size-full">
      <Tabs
        ...
        color="primary"
        variant="light"
        className="top-50 z-50 flex h-10 md:top-40 md:w-fit md:justify-center"
        classNames={{
          tabList:
          ...
          base: "absolute overflow-x-scroll transition-all duration-300 flex top-2 justify-center w-[calc(100vw)] sm:w-full md:left-80 sm:left-0 z-[200] -top-4 xl:left-[calc(30vw)] lg:w-[calc(36vw)] lg:left-80 lg:w-[calc(50vw)]",
          wrapper:
