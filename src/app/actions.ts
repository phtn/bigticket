...
const cookieNameMap: Record<CookieType, string> = {
  theme: "bigticket--themes",
  darkMode: "bigticket--dark-mode-enabled",
  soundEnabled: "bigticket--sound-enabled",
  userId: "bigticket--user-id",
  userEmail: "bigticket--user-email",
  fingerprint: "bigticket--fingerprint",
