  ...
  (
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className="_bg-void/10 absolute top-0 z-[0] h-full w-screen" />
        <WarpDrive
          gridColor="#fff"
          className="absolute -top-4 z-10 flex h-full w-full items-center justify-center bg-slate-500 p-0 shadow-none"
        >
          <div />
        </WarpDrive>
