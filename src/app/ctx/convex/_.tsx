...
//   const queryAllEvents = useQuery(api.events.get.all);
//   const getEventById = useCallback(
//     async (id: string) => useQuery(api.events.get.byId, { id }) ?? null,
//     [],
//   );
//   const getEventByIds = async (ids: string[]) =>
//     useQuery(api.events.get.byIds, { ids });
//   const getEventsByHostId = async (host_id: string) =>
//     useQuery(api.events.get.byHostId, { host_id });

//   const events = useMemo(
//     () => ({
//       getAllEvents: () => queryAllEvents,
//       create: async (args: InsertEvent) => await createEvent(args),
//       get: {
//         byId: getEventById,
//         byIds: getEventByIds,
//         byHostId: getEventsByHostId,
//       },
//       update: {
//         status: async (id: string, is_active: boolean) =>
